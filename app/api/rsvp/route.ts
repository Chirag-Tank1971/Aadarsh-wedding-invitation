...
export async function POST(request: NextRequest) {
  try {
    ...
    const recipientEmail = process.env.RSVP_EMAIL_ADDRESS || "aadarsh.pragya.2026@gmail.com";
    ...
    await resend.emails.send({
      from: "Aadarsh & Pragya <onboarding@resend.dev>",
      to: recipientEmail,
      subject: "RSVP Received - Aadarsh & Pragya's Wedding Celebration",
      html: `
        <!DOCTYPE html>
        <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                ...
                <p style="margin-top: 20px;">We're looking forward to creating wonderful memories together on March 8-11, 2026 in Ghaziabad.</p>
                <p>If you have any questions or need to make changes, please don't hesitate to reach out.</p>
                <p>With love and joy,<br/><strong>Aadarsh & Pragya</strong></p>
              </div>
              <div class="footer">
                <p>📍 Ghaziabad | 📅 March 8-11, 2026</p>
              </div>
            </div>
          </body>
        </html>
